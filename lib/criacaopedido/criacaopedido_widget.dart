...
import 'criacaopedido_model.dart';
export 'criacaopedido_model.dart';

class CriacaopedidoWidget extends StatefulWidget {
  const CriacaopedidoWidget({
    Key? key,
  ...
  @override
  _CriacaopedidoWidgetState createState() => _CriacaopedidoWidgetState();
}

class _CriacaopedidoWidgetState extends State<CriacaopedidoWidget> {
  late CriacaopedidoModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => CriacaopedidoModel());
                    ...
                    children: [
                      FFButtonWidget(
                        onPressed: () async {
                          ...
                          await VendasRecord.createDoc(widget.refPedido!)
