...
import 'schema/vendas_separadas_record.dart';
...
export 'schema/vendas_separadas_record.dart';
...
Future<int> queryVendasRecordCount({
  ...
  int limit = -1,
    ...
    queryCollectionCount(
      VendasRecord.collection(parent),
      queryBuilder: queryBuilder,
      limit: limit,
    );
...
/// Functions to query VendasSeparadasRecords (as a Stream and as a Future).
Future<int> queryVendasSeparadasRecordCount({
  Query Function(Query)? queryBuilder,
  int limit = -1,
}) =>
    queryCollectionCount(
      VendasSeparadasRecord.collection,
      queryBuilder: queryBuilder,
      limit: limit,
    );

Stream<List<VendasSeparadasRecord>> queryVendasSeparadasRecord({
  Query Function(Query)? queryBuilder,
  int limit = -1,
  bool singleRecord = false,
}) =>
    queryCollection(
      VendasSeparadasRecord.collection,
      VendasSeparadasRecord.fromSnapshot,
      queryBuilder: queryBuilder,
      limit: limit,
      singleRecord: singleRecord,
    );

Future<List<VendasSeparadasRecord>> queryVendasSeparadasRecordOnce({
  Query Function(Query)? queryBuilder,
  int limit = -1,
  bool singleRecord = false,
}) =>
